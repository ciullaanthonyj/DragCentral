...
extern __declspec (package) const GUID CLSID_FlashProp;
...
typedef IUnknownPtr FlashPropPtr;
typedef IDispatchEx FlashObjectInterface;
typedef IDispatchExPtr FlashObjectInterfacePtr;

#define LIBID_OF_ShockwaveFlash (&LIBID_ShockwaveFlashObjects)
#define LIBID_OF_FlashProp (&LIBID_ShockwaveFlashObjects)
...
public:
  ...
  __property   BSTR            Movie = {read = get_Movie};
  __property   long            FrameNum = {read = get_FrameNum, write = set_FrameNum};
  __property   BSTR            WMode = {read = get_WMode};
  __property   BSTR            SAlign = {read = get_SAlign};
  __property   VARIANT_BOOL    Menu = {read = get_Menu, write = set_Menu};
  __property   BSTR            Base = {read = get_Base};
  __property   BSTR            Scale = {read = get_Scale};
  ...
  __property   BSTR            BGColor = {read = get_BGColor};
  __property   BSTR            Quality2 = {read = get_Quality2};
  __property   BSTR            SWRemote = {read = get_SWRemote};
  __property   BSTR            FlashVars = {read = get_FlashVars};
  __property   BSTR            AllowScriptAccess = {read = get_AllowScriptAccess};
  __property   BSTR            MovieData = {read = get_MovieData};
  ...
  __property   BSTR            ProfileAddress = {read = get_ProfileAddress};
...
public:
  ...
  HRESULT         __fastcall RemoteInvokeEx(long id/*[in]*/, unsigned_long lcid/*[in]*/, 
                                            ...
                                            /*AUTO_PARAM_ERROR(DISPPARAMS* pdp)*/ TVariant&  pdp, 
                                            VARIANT* pvarRes/*[out]*/, 
                                            /*AUTO_PARAM_ERROR(EXCEPINFO* pei)*/ TVariant&  pei, 
                                            Shockwaveflashobjects_tlb::IServiceProvider* pspCaller/*[in]*/
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::get_Playing(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Playing(VARIANT_BOOL*)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::set_Playing(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Playing(VARIANT_BOOL)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::get_Loop(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Loop(VARIANT_BOOL*)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::set_Loop(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Loop(VARIANT_BOOL)pVal);
}
...
{
  VARIANT_BOOL loaded;
  OLECHECK(this->FrameLoaded(, (VARIANT_BOOL*)&loaded));
  return loaded;
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::get_Menu(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Menu(VARIANT_BOOL*)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::set_Menu(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Menu(VARIANT_BOOL)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::get_DeviceFont(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_DeviceFont(VARIANT_BOOL*)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::set_DeviceFont(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_DeviceFont(VARIANT_BOOL)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::get_EmbedMovie(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_EmbedMovie(VARIANT_BOOL*)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::set_EmbedMovie(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_EmbedMovie(VARIANT_BOOL)pVal);
}
...
{
  long FrameNum;
  OLECHECK(this->TCurrentFrame(, (long*)&FrameNum));
  return FrameNum;
}
...
{
  BSTR pVal = 0;
  OLECHECK(this->TCurrentLabel(, (BSTR*)&pVal));
  return pVal;
}
...
{
  BSTR pVal = 0;
  OLECHECK(this->GetVariable(, (BSTR*)&pVal));
  return pVal;
}
...
{
  BSTR pVal = 0;
  OLECHECK(this->TGetProperty(, (BSTR*)&pVal));
  return pVal;
}
...
{
  double pVal;
  OLECHECK(this->TGetPropertyNum(, (double*)&pVal));
  return pVal;
}
...
{
  double pVal;
  OLECHECK(this->TGetPropertyAsNumber(, (double*)&pVal));
  return pVal;
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::get_SeamlessTabbing(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_SeamlessTabbing(VARIANT_BOOL*)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::set_SeamlessTabbing(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_SeamlessTabbing(VARIANT_BOOL)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::get_Profile(TOLEBOOL* pVal/*[out,retval]*/)
{
  return (*this)->get_Profile(VARIANT_BOOL*)pVal);
}
...
template <class T> HRESULT __fastcall
TCOMIShockwaveFlashT<T>::set_Profile(TOLEBOOL pVal/*[in]*/)
{
  return (*this)->set_Profile(VARIANT_BOOL)pVal);
}
...
{
  BSTR response = 0;
  OLECHECK(this->CallFunction(, (BSTR*)&response));
  return response;
}
...
// Interface: IDispatchExDisp
// *********************************************************************//
typedef TCoClassCreatorT<IDispatchExDisp, IDispatchEx, &CLSID_FlashObjectInterface, &IID_IDispatchEx> CoFlashObjectInterface;
#endif  //   __TLB_NO_INTERFACE_WRAPPERS
